...
public class TeamDao {
	...
	public List<Team> view_All_Team() {
		List<Team> teams=entityManager.createQuery("select z from Team z").getResultList();
	...
	public Team fetchAllTeamUsingName(String name) {
